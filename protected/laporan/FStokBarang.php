...
class FStokBarang extends fpdf{
    private $data = array();
    ...
    function master() {
        ...
        $this->Cell(530, 10, 'LAPORAN STOK BARANG', 0, 0, 'C');
        $this->Ln();
        $this->Ln();
        $y = 60;
        ...
        $this->tanggal = new Fungsi();
            ...
            $this->Cell(100, 20, 'Tanggal                : '.$this->tanggal->waktuIndo($this->periode), 0, 0, 'L');
            $this->Ln();
        $this->Ln();
    }
    ...
    public function detil() {
        ...
        $this->Cell($w[3],$h,'Stok' ,1,0,'C' ,true);
        $this->Ln();
