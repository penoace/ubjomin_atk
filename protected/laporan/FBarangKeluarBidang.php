...
class FBarangKeluarBidang extends fpdf{
    private $bidang;
    private $data = array();
    ...
    function __construct($bidang, $data = array(), $options = array(), $periode) {
        parent::__construct();
        $this->bidang= $bidang;
        $this->data = $data;
    ...
    function master() {
        ...
        $this->Cell(530, 10, 'LAPORAN BARANG KELUAR', 0, 0, 'C');
        $this->Ln();
        $this->Ln();
        $y = 60;
        ...
        $this->tanggal = new Fungsi();
            ...
            $this->Cell(100, 20, 'Bidang                 : '.$this->bidang, 0, 0, 'L');
            $this->Ln();
